    ...
    <aside>
      ...
      <div className='space-y-3'>
        <section className='bg-gray-100 text-[15px] lg:bg-white'>
          <div>
            <div className='mx-auto w-fit translate-y-10 rounded-lg bg-gray-100 px-5 py-3 pt-5 md:flex md:w-full md:translate-y-0 md:items-center md:gap-1 md:rounded-none lg:py-10 lg:gap-5 lg:items-center'>
