      ...
      <section className="lg:hidden min-h-screen flex flex-col items-center justify-center gap-4 bg-gray-50">
        ...
        <div className="w-full px-5">
          <div className="w-full max-w-[35rem] p-5 !pb-10">
            ...
            <p className="mt-1 text-[13px] text-gray-600">Set a new password for your account. Minimum 8 characters.</p>
          </div>
          <form className="w-full max-w-[35rem] p-5 !pt-0 !pb-10">
            <div className="space-y-6">
              ...
              <label className="flex flex-col gap-1.5">
                <span className="font-medium uppercase">New Password <span className="text-red-600 text-lg">*</span></span>
              ...
              <label className="flex flex-col gap-1.5">
                <span className="font-medium uppercase">Confirm Password <span className="text-red-600 text-lg">*</span></span>
                <div className="relative flex justify-between items-center gap-3.5 border border-gray-300 border-solid px-3.5 py-0.5 rounded-2xl transition-all focus-within:border-gray-500/80 bg-white">
                  <input
            ...
            <div className="mt-8 flex items-center justify-between">
              ...
              <button type="submit" className="rounded-2xl bg-[#26A7DF] py-2.5 px-4 font-medium text-white">Reset Password</button>
            </div>
          </form>
        </div>
      </section>
            ...
            <div className="bg-white relative before:absolute z-10 before:-z-10 before:[clip-path:polygon(50%_0%,100%_0%,100%_100%,0%_100%,25%_50%)] before:bg-[#8AC440] shadow-xl shadow-gray-200/70 overflow-hidden flex flex-row-reverse items-center before:w-full before:h-full border border-solid border-gray-200 rounded-lg">
              ...
              <div className="w-[45%] rounded-lg shadow-2xl bg-white m-5">
                <div className="px-10 pt-10">
                  <h1 className="text-[22px] font-semibold text-gray-900">Reset Password</h1>
                  <p className="mt-1 text-[13px] text-gray-600">Set a new password for your account. Make sure it is at least 8 characters long and not used elsewhere.</p>
                </div>
                <form className="w-full p-5 !pb-10 px-10">
                  <div className="space-y-6 pt-6">
                    ...
                    <label className="flex flex-col gap-1.5">
                      <span className="text-[16px] font-medium">New Password <span className="text-red-600 text-lg">*</span></span>
                      <div className="relative flex justify-between items-center gap-3.5 border border-gray-300 border-solid px-2.5 rounded-lg transition-all focus-within:border-gray-500/80">
                        <input
                          type={showPassword ? 'text' : 'password'}
                          name="password"
                          minLength={8}
                    ...
                    <label className="flex flex-col gap-1.5">
                      <span className="text-[16px] font-medium">Confirm Password <span className="text-red-600 text-lg">*</span></span>
                      <div className="relative flex justify-between items-center gap-3.5 border border-gray-300 border-solid px-2.5 rounded-lg transition-all focus-within:border-gray-500/80">
                        <input
                          type={showConfirm ? 'text' : 'password'}
                          name="confirmPassword"
                  ...
                  <div className="mt-10 flex items-center justify-between">
                    <Link to="/login" className="text-[14px] text-gray-600 hover:text-gray-800">Back to login</Link>
                    <button type="submit" className="rounded bg-[#26A7DF] py-2 px-4 font-medium text-white">Reset Password</button>
                  </div>
                </form>
              </div>
              ...
              {/* Image */}
              <div className="w-[55%]">
                <img src="./login.svg" alt="Reset Password" className="h-full w-full drop-shadow-lg" />
              </div>
            </div>
          </section>
        </div>
