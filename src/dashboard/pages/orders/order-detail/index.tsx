  ...
  return (
    <section className="max-w-4xl">
      ...
      <div className="mb-8 flex items-center gap-4">
        <div>
          ...
          <p className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <button
              type="button"
              className="inline-flex cursor-pointer items-center gap-1 rounded-full border border-gray-200 bg-white px-2 py-0.5 text-xs font-medium text-gray-600 transition hover:border-blue-300 hover:bg-blue-50 hover:text-blue-700"
      ...
      <div className="flex gap-4 *:w-1/2 *:lg:w-fit">
        {order.status === "delivered" ? (
          <button className="inline-flex h-11 items-center justify-center gap-2 rounded-lg border border-amber-200 bg-amber-50 px-3.5 text-sm font-semibold text-amber-600 transition-colors duration-200 hover:border-amber-300 hover:bg-amber-100 lg:px-6">
            <Star size={16} />
            Rate Order
          </button>
        ) : order.status === "in-progress" ? (
          <button className="inline-flex h-11 items-center justify-center gap-2 rounded-lg border border-blue-200 bg-blue-50 px-3.5 text-sm font-semibold text-blue-600 transition-colors duration-200 hover:border-blue-300 hover:bg-blue-100 lg:px-6">
            <Truck size={16} />
            Track Package
          </button>
        ) : (
          <button className="inline-flex h-11 items-center justify-center gap-2 rounded-lg border border-gray-200 bg-gray-100 px-3.5 text-sm font-semibold text-gray-600 transition-colors duration-200 hover:border-gray-300 hover:bg-gray-200 hover:text-gray-700 lg:px-6">
            <Download size={16} />
            Download Invoice
          </button>
        )}
        <button className="inline-flex h-11 items-center justify-center gap-2 rounded-lg border border-gray-200 bg-gray-100 px-3.5 text-sm font-semibold text-gray-700 transition-colors duration-200 hover:border-gray-300 hover:bg-gray-200 hover:text-gray-900 lg:px-6">
